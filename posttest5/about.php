...
@media (max-width: 768px) {
    .hamburger {
    display: flex; /* Tampilkan hamburger di layar mobile */
    flex-direction: column;
    cursor: pointer;
    position: fixed;
    top: 20px;
...
<body>
    ...
    <div class="about-section" id="about">
        ...
        <p><strong>Universitas:</strong> Universitas Mulawarman, Jl. Kuaro, Gn. Kelua, Kec. Samarinda Ulu, Kota Samarinda, Kalimantan Timur 75119.</p>
        <p><strong>Praktikum web:</strong> <a href="https://classroom.google.com/c/NzEwMjM0NDcyMzE3/a/NzA2NzI0Nzc4MzA3/details">Posttest4</a></p>
    </div>
