...
.container {
    ...
    /* Menempatkan elemen kiri dan kanan di awal */
    align-items: flex-start;
    padding: 20px;
    /* Tambahkan padding agar kontainer tidak terlalu sempit */
}
...
.item a {
    ...
    font-size: 30px;
    flex-grow: 1;
    /* Membuat teks berkembang sesuai ruang */
}
